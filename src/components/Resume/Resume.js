...
import {AtSign,Calendar,GitHub,Linkedin,MapPin,Paperclip,Phone,ArrowDown} from "react-feather";
...
const a = useContext(ResumeContext);
  ...
  const information = a.resumeInformation;
  ...
  useEffect(() => {
    ...
    if (!a.activeColor || !container) return;

    container.style.setProperty("--color", a.activeColor);
  }, [a.activeColor]);

  return (
    <>
    <p className={styles.heading}>Resume Preview</p>
